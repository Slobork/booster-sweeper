...
if (! function_exists('booster_sweeper_framework_settings')) {
     ...
     * @return void
     */
    function booster_sweeper_framework_settings() {
    ...
    add_action('csf_loaded', 'booster_sweeper_framework_settings');
