<?php
	...
	if ( ! is_multisite() || (is_multisite() && is_main_site()) ) {
		...
		// Since the "Unistall settings" is the only option under the "Other" heading, $settings_other_heading is also conditionally set based on the multisite environment
