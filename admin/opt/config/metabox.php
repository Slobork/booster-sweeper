<?php
	...
	// this is the only way to get it working on all post types, though _builtin is set to false, it actually appears on all post types (buitin and not builtin)
	...
	if ($exclude_settings_indi !== '1') {
		...
		CSF::createMetabox( '_mb_booster_sweeper', array(
		...
		CSF::createSection( '_mb_booster_sweeper', array(
			'fields' => array(
